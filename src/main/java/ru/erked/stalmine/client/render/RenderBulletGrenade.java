...
public class RenderBulletGrenade<T extends EntityBulletGrenade> extends Render<T> {

    IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation(StalmineMod.MODID,
            "models/item/am_vog25.obj"));

    public RenderBulletGrenade(RenderManager renderManager) {
        super(renderManager);
    }
    ...
    protected ResourceLocation getEntityTexture(T entity) {
        return new ResourceLocation(StalmineMod.MODID, "textures/items/am_vog25.png");
    }

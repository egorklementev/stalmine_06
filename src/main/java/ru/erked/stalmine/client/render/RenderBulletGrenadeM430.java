...
public class RenderBulletGrenadeM430<T extends EntityBulletGrenadeM430> extends Render<T> {

    IModelCustom model = AdvancedModelLoader.loadModel(new ResourceLocation(StalmineMod.MODID,
            "models/item/am_m430.obj"));

    public RenderBulletGrenadeM430(RenderManager renderManager) {
        super(renderManager);
    }
    ...
    protected ResourceLocation getEntityTexture(T entity) {
        return new ResourceLocation(StalmineMod.MODID, "textures/items/am_m430.png");
    }

...
public class ModelKombez extends ModelBiped {
    ...
    private void renderChest(IModelCustom model) {
        ...
        GlStateManager.translate(0f, -.615f, .1f);
        model.renderAll();
        GlStateManager.popMatrix();
    }

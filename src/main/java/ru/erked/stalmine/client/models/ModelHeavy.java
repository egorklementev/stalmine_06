...
public class ModelHeavy extends ModelBiped {
    ...
    IModelCustom chest = AdvancedModelLoader.loadModel(new ResourceLocation(
            StalmineMod.MODID, "models/armor/arm_heavy_chest.obj"));
    IModelCustom arm = AdvancedModelLoader.loadModel(new ResourceLocation(
            StalmineMod.MODID, "models/armor/arm_heavy_arm.obj"));
    IModelCustom leg = AdvancedModelLoader.loadModel(new ResourceLocation(
            StalmineMod.MODID, "models/armor/arm_heavy_leg.obj"));
    ...
    public ModelHeavy(String texture, int id) {

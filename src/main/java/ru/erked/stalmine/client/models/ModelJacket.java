...
public class ModelJacket extends ModelBiped {
    ...
    private void renderChest(IModelCustom model) {
        ...
        GlStateManager.scale(.375f, .31f, .35f);
        GlStateManager.translate(0f, -.615f, .2f);
        model.renderAll();
        GlStateManager.popMatrix();
    }
    ...
    private void renderArm(IModelCustom model, float p) {
        ...
        GlStateManager.translate(-.2f * p, -.75f, 0f);
        model.renderAll();
        GlStateManager.popMatrix();
    }

...
public class ModelScientist extends ModelBiped {
    ...
    IModelCustom chest = AdvancedModelLoader.loadModel(new ResourceLocation(
            StalmineMod.MODID, "models/armor/arm_scientist_chest.obj"));
    IModelCustom arm = AdvancedModelLoader.loadModel(new ResourceLocation(
            StalmineMod.MODID, "models/armor/arm_scientist_arm.obj"));
    IModelCustom leg = AdvancedModelLoader.loadModel(new ResourceLocation(
            StalmineMod.MODID, "models/armor/arm_scientist_leg.obj"));
    IModelCustom head = AdvancedModelLoader.loadModel(new ResourceLocation(
            StalmineMod.MODID, "models/armor/arm_scientist_head.obj"));
    IModelCustom boot = AdvancedModelLoader.loadModel(new ResourceLocation(
            StalmineMod.MODID, "models/armor/arm_scientist_boot.obj"));

    ResourceLocation texture;
    private int id;

    public ModelScientist(String texture, int id) {

...
public class ModelSeva extends ModelBiped {
    ...
    private void renderChest(IModelCustom model) {
        ...
        GlStateManager.translate(0f, -.9f, .1f);
        model.renderAll();
        GlStateManager.popMatrix();
    }

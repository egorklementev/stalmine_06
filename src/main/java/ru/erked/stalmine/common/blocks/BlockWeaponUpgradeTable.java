...
public class BlockWeaponUpgradeTable extends Block implements ITileEntityProvider {

    public static final int GUI_ID = 2;

    public static final PropertyDirection FACING = PropertyDirection.create("facing");

    public BlockWeaponUpgradeTable() {
        super(Material.CLOTH);
        setUnlocalizedName(StalmineMod.MODID + ".wpn_upgrade_table");
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TEWeaponUpgradeTable();
    }
